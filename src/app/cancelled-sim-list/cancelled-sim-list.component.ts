...
@Component({
  ...
  templateUrl: './cancelled-sim-list.component.html',
  encapsulation: ViewEncapsulation.None
})

export class CancelledSIMListComponent implements OnInit {
  ...
  getList() {
    ...
    this._service.get('stock/get-cancelled-sim-list',obj).subscribe((res:any) => {
