...
export class BuildingComponent implements OnInit {  
  ...
  getList() {
    ...
    this._service.get('building/list', obj).subscribe(res => {
  ...
  getItem(id) {
    ...
    this._service.get('building/get/' + id).subscribe(res => {
      ...
      this.formTitle = 'Update Building';
  ...
  onFormSubmit() {
    ...
    const request = this._service.post('building/create-or-update', obj);
