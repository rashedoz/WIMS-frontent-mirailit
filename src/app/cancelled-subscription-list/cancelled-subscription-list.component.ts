...
@Component({
  selector: 'app-cancelled-subscription-list',
  templateUrl: './cancelled-subscription-list.component.html',
  styleUrls:['./cancelled-subscription-list.component.css'],
  encapsulation: ViewEncapsulation.None
})

export class CancelledSubscriptionListComponent implements OnInit {
  ...
  getListWholesaler() {
    ...
    this._service.get('subscription/get-wholesaler-cancelled-subscription-list',obj).subscribe(res => {
  ...
  getListRetailer() {
    ...
    this._service.get('subscription/get-retailer-cancelled-subscription-list',obj).subscribe(res => {
