...
@Component({
  selector: "app-unfreeze-sims",
  templateUrl: "./unfreeze-sims.component.html",
  encapsulation: ViewEncapsulation.None,
})
export class UnFreezeSIMsComponent implements OnInit {
  entryForm: FormGroup;
  ...
  modalTitle = "Add ";
  btnSaveText = "Save To Unfreeze SIM";
  ...
  onFormSubmit() {
   ...
   this.blockUI.start('Saving...');
    ...
    this.confirmService.confirm('Are you sure?', 'You are unfreezing the SIM(s).')
      .subscribe(
        result => {
          if (result) {
            this._service.post('stock/unfreeze-sims', obj).subscribe(
              data => {
                this.blockUI.stop();
