...
export class SubscriptionBillListComponent implements OnInit {
  ...
  url = 'subscription/get-unpaid-subscription-bill-list';
  ...
  changeTab(type,e) {
    ...
    switch (type) {
      case 'Fully Paid':
        this.url = 'subscription/get-fully-paid-subscription-bill-list';
        this.getList();
        break;
      case 'Partially Paid':
        this.url = 'subscription/get-partially-paid-subscription-bill-list';
     this.getList();
        break;
      case 'Unpaid':
        this.url = 'subscription/get-unpaid-subscription-bill-list';
     this.getList();
        break;
    default:
      this.url = 'subscription/get-unpaid-subscription-bill-list';
